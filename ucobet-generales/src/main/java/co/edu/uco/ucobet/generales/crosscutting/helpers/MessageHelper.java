...
import co.edu.uco.ucobet.generales.crosscutting.messagecatalog.ApplicationContextProvider;
...
public class MessageHelper {
    ...
    public static MessageHelper getInstance() {
        return ApplicationContextProvider.getBean(MessageHelper.class);
    }
